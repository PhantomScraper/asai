...
sourceUrl: "https://docs.leapslabs.com/zh-cn/pans-pro-rtls/integration-guide/api-commands/dwm-panid-get/"
order: 204
---
...
<li><p><strong>output</strong> – 16 位无符号整数 (<em>PAN ID</em>)</p></li>
</ul>
</dd>
</dl>
</dd></dl>
...
<p>类型 0x2F 表示命令 dwm_panid_get</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 17%">
<col style="width: 17%">
...
<div class="line">类型 0x4D 表示 PANID</div>
</div>
</div>
