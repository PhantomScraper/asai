...
sourceUrl: "https://docs.leapslabs.com/zh-cn/pans-pro-rtls/integration-guide/api-commands/dwm-nvm-usr-data-set/"
order: 203
---
...
<p>将用户数据存储到非易失性存储器，并写入内部非易失性存储器，必须小心使用。 旧数据会被重写。</p>
<dl class="c function">
...
<li><p><strong>input</strong> – 数据, len</p></li>
<li><p><strong>data</strong> – 最大 250 字节 (<em>要写入的用户数据</em>)</p></li>
