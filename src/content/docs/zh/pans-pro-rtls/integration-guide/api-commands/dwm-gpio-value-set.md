...
sourceUrl: "https://docs.leapslabs.com/zh-cn/pans-pro-rtls/integration-guide/api-commands/dwm-gpio-value-set/"
order: 165
---
...
<p>类型 0x2a 表示命令 <a class="reference internal" href="#dwm-gpio-value-set"><span class="std std-ref">dwm_gpio_value_set</span></a>。</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
