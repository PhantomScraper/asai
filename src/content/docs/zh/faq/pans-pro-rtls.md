...
section: "faq"
sourceUrl: "https://docs.leapslabs.com/zh-cn/faq/pans-pro-rtls/"
order: 31
---
...
<ul class="simple">
<li><p class="sd-card-text">LEAPS 拥有 PANS 软件栈，可以自由使用。</p></li>
<li><p class="sd-card-text">请参阅 <a class="reference internal" href="/docs/zh/leaps-solutions/comparison#comparision"><span class="std std-ref">比较</span></a> 了解更多详情。</p></li>
</ul>
</div>
</details></div>
