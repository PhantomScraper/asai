...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/zh-cn/leaps-rtls/infrastructure/leaps-server/"
order: 70
---
...
<p>LEAPS Server是UWB网络的中央数据中心。它通过 <a class="reference external" href="https://mosquitto.org/">MQTT代理</a> 将所有 <a class="reference internal" href="/docs/zh/leaps-rtls/infrastructure/leaps-gateway#leapsgateway"><span class="std std-ref">LEAPS Gateway</span></a> 设备与世界互连。</p>
<hr class="docutils">
...
<li><p><a class="reference internal" href="#leapsserver"><span class="std std-ref">LEAPS Server</span></a> 在Linux平台上作为守护进程服务运行。</p></li>
</ul>
</div>
<hr class="docutils">
...
<p>leaps_server实例正在使用端口“7777”与 <a class="reference internal" href="/docs/zh/leaps-rtls/infrastructure/leaps-gateway#leapsgateway"><span class="std std-ref">LEAPS Gateway</span></a> 进行 <code class="docutils literal notranslate"><span class="pre">TCP</span></code> 和 <code class="docutils literal notranslate"><span class="pre">UDP</span></code> 通信，因此需要使用命令 <code class="docutils literal notranslate"><span class="pre">-p</span> <span class="pre">777777:7777/TCP-p</span> <span class="pre">77779/UDP</span></code> 将这些端口从主机重新映射到leaps_server实例。</p>
<p>除非需要，否则不建议更改端口号。如果需要修改，请相应地调整 <a class="reference internal" href="/docs/zh/leaps-rtls/infrastructure/leaps-gateway#leapsgateway"><span class="std std-ref">LEAPS Gateway</span></a> 上的端口设置。</p>
<ul class="simple">
<li><p>推荐的运行选项</p>
<ul>
...
<li><p>删除LEAPS Server，运行 <code class="docutils literal notranslate"><span class="pre">docker</span> <span class="pre">rm--force</span> <span class="pre">leaps_server</span></code></p></li>
</ul>
</div>
<hr class="docutils">
...
<li><p>在 <a class="reference internal" href="#leapsserver"><span class="std std-ref">LEAPS Server</span></a> 运行时检查日志，打开docker桌面并选择leaps_server容器。</p></li>
</ul>
</div>
</div>
