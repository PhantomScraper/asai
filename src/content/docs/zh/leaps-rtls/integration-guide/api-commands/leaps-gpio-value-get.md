...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/zh-cn/leaps-rtls/integration-guide/api-commands/leaps-gpio-value-get/"
order: 245
---
...
输入</div>
<ul class="simple">
<li><p class="sd-card-text"><a class="reference internal" href="/docs/zh/leaps-rtls/integration-guide/leaps-api/api-generic-data-types#gpioidx"><span class="std std-ref">gpio_idx</span></a></p></li>
</ul>
</div>
</div>
</div>
...
<li><p class="sd-card-text">gpio_val: 8位无符号整数(0|1)</p></li>
</ul>
</div>
</div>
</div>
...
<p>类型0x2b表示命令leaps_gpio_value_get</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 20%">
<col style="width: 17%">
...
<tr class="row-odd"><td><p>引脚值（0,1）</p></td>
</tr>
