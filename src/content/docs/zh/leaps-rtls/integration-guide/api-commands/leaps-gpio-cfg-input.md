...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/zh-cn/leaps-rtls/integration-guide/api-commands/leaps-gpio-cfg-input/"
order: 244
---
...
<li><p class="sd-card-text">gpio_pull: 8 位无符号整数(0 无拉，1拉下，3拉上*)</p></li>
</ul>
</div>
</div>
</div>
...
<p>类型0x29表示命令leaps_gpio_cfg_input</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
