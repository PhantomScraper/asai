...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/zh-cn/leaps-rtls/integration-guide/api-commands/leaps-label-write/"
order: 270
---
...
输入</div>
<ul class="simple">
<li><p class="sd-card-text">标签</p></li>
<li><p class="sd-card-text">len</p></li>
<li><p class="sd-card-text">data: 最多10个字节（<em>要写入的标签字节</em>）</p></li>
</ul>
</div>
</div>
</div>
...
<tr class="row-odd"><td><p>标签，最大10个字节</p></td>
</tr>
...
<p>类型0x1D表示命令leaps_label_write</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
