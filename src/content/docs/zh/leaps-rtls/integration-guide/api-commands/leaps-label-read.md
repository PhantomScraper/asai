...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/zh-cn/leaps-rtls/integration-guide/api-commands/leaps-label-read/"
order: 269
---
...
<li><p class="sd-card-text">data: 0 -10 bytes (<em>标签</em>)</p></li>
</ul>
</div>
</div>
</div>
...
<p>键入0x1C表示命令leaps_label_read</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 13%">
<col style="width: 14%">
...
<tr class="row-odd"><td><p>最多10字节</p></td>
</tr>
