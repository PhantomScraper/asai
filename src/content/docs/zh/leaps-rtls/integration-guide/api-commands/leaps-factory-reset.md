...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/zh-cn/leaps-rtls/integration-guide/api-commands/leaps-factory-reset/"
order: 231
---
...
<p>将节点设置为出厂设置。 环境被擦除并设置为默认状态。 重置节点。 此调用会写入内部闪存，因此不应频繁使用，最坏的情况下可能需要数百毫秒！</p>
<hr class="docutils">
...
<p>类型0x13表示命令leaps_factory_reset</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
