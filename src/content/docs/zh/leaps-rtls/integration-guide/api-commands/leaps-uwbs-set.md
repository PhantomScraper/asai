...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/zh-cn/leaps-rtls/integration-guide/api-commands/leaps-uwbs-set/"
order: 278
---
...
<li><p class="sd-card-text">uwbs_mode: ‘0’ | ‘1’ (<em>对于 LEAPS RTLS，此字段未使用，它会在切换到 FIRA 模式前应用模式设置. 对于 FIRA，0=UCI，1=NIQ</em>)</p></li>
</ul>
</div>
</div>
</div>
