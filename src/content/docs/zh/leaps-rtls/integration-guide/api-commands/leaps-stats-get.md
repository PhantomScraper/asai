...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/zh-cn/leaps-rtls/integration-guide/api-commands/leaps-stats-get/"
order: 283
---
...
<li><p class="sd-card-text">统计数据：204字节</p></li>
</ul>
</div>
</div>
</div>
...
<thead>
<tr class="row-odd"><th class="head" colspan="3"><p>统计数据（按顺序）</p></th>
</tr>
</thead>
<tbody>
<tr class="row-even"><td rowspan="2"><p>类型</p></td>
<td rowspan="2"><p>大小（字节）</p></td>
<td rowspan="2"><p>名称</p></td>
</tr>
<tr class="row-odd"></tr>
...
<tr class="row-even"><td><p>浮动</p></td>
<td><p>4</p></td>
...
<tr class="row-odd"><td><p>统计数据（204字节）</p></td>
</tr>
