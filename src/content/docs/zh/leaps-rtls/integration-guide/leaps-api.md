...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/zh-cn/leaps-rtls/integration-guide/leaps-api/"
order: 67
---
...
<ul class="simple">
<li><p><a class="reference internal" href="/docs/zh/leaps-rtls/integration-guide/leaps-api/tlv-api#leaps-tlv-api"><span class="std std-ref">TLV API</span></a> 部分提供了 <strong>二进制</strong> TLV 命令的指南。</p></li>
<li><p><a class="reference internal" href="/docs/zh/leaps-rtls/integration-guide/leaps-api/shell-api#leaps-shell-api"><span class="std std-ref">壳牌API</span></a> 部分描述了 <strong>人可读的</strong> 命令行界面命令。</p></li>
<li><p><a class="reference internal" href="/docs/zh/leaps-rtls/integration-guide/leaps-api/mqtt-api#leaps-mqtt-api"><span class="std std-ref">MQTT API</span></a> 部分描述了MQTT的 <strong>消息</strong>。</p></li>
</ul>
<p><a class="reference external" href="https://www.leapslabs.com/">LEAPS</a> device supports communication over multiple interfaces. Refer to <a class="reference internal" href="/docs/zh/leaps-rtls/integration-guide/leaps-api/supported-interfaces#leaps-api-interfaces"><span class="std std-ref">list of supported interfaces</span></a> for details.</p>
...
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="/docs/zh/leaps-rtls/integration-guide/leaps-api/leaps-com/how-to-install">How to install ?</a></li>
<li class="toctree-l1"><a class="reference internal" href="/docs/zh/leaps-rtls/integration-guide/leaps-api/leaps-com/cmd-execution">Concurrent command execution</a></li>
<li class="toctree-l1"><a class="reference internal" href="/docs/zh/leaps-rtls/integration-guide/leaps-api/leaps-com/fw-update">Firmware update</a></li>
<li class="toctree-l1"><a class="reference internal" href="/docs/zh/leaps-rtls/integration-guide/leaps-api/leaps-com/cert-update">Certificate update</a></li>
</ul>
</div>
</div>
</div>
