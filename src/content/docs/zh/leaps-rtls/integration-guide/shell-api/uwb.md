...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/zh-cn/leaps-rtls/integration-guide/shell-api/uwb/"
order: 138
---
...
<div><ul class="simple">
<li><p>ch: 5,9</p></li>
<li><p>cpl:0=FCC/ETSI，1=ETSI+10dB，2=ARIB仅适用于ch 9</p></li>
<li><p>pcode: 9,10,11,12</p></li>
</ul>
</div></blockquote>
<div class="admonition note">
<p class="admonition-title">注解</p>
<p>ucs命令的&lt;pcode&gt;参数是可选的。如果用户不提供输入，将使用下面指定的默认值。</p>
<blockquote>
<div><ul class="simple">
<li><p>频道2:Tx/Rx前导码=11</p></li>
<li><p>频道3:Tx/Rx前导码=12</p></li>
<li><p>频道5:Tx/Rx前导码=9</p></li>
<li><p>频道9:Tx/Rx前导码=11</p></li>
</ul>
</div></blockquote>
<p>频道2和频道3仅支持 ‘0=FCC/ETSI’</p>
</div>
</div></blockquote>
<p>示例 (DW3000)</p>
<blockquote>
