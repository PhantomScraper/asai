...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/zh-cn/leaps-rtls/integration-guide/shell-api/api/"
order: 140
---
...
<p>使用给定的选项将节点配置为标签。此命令需要重置才能使新配置生效。</p>
<p>示例:</p>
...
<p>Example: Read user data from the node (<a class="reference internal" href="/docs/zh/leaps-rtls/integration-guide/api-commands/leaps-usr-data-read#leaps-usr-data-read"><span class="std std-ref">leaps_usr_data_read</span></a>)</p>
<p>Decimal format:</p>
...
<p>使用给定的选项将节点配置为锚点。此命令需要重置才能使新配置生效。</p>
<p>示例:</p>
...
<p>配置过滤器，例如测量过滤器、位置过滤器、测量选择策略等。</p>
<p>示例:</p>
...
<div class="admonition note">
<p class="admonition-title">注解</p>
<p>如果id=1-loc，则参数（字节[0]）指定是启用还是禁用位置的移动平均过滤器。</p>
</div>
<hr class="docutils">
</div>
<div class="section" id="flg">
<span id="id17"></span><h2>flg</h2>
<p>获取过滤器，例如测量过滤器、位置过滤器、测量选择策略等。</p>
<p>示例:</p>
