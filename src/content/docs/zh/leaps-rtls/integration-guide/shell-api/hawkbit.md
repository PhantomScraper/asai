...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/zh-cn/leaps-rtls/integration-guide/shell-api/hawkbit/"
order: 142
---
...
<p>Check the configuration again with the <a class="reference internal" href="/docs/zh/leaps-rtls/integration-guide/shell-api/sys#si"><span class="std std-ref">si</span></a> command.</p>
</div></blockquote>
<hr class="docutils">
</div>
