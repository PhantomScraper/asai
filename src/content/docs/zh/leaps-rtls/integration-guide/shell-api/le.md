...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/zh-cn/leaps-rtls/integration-guide/shell-api/le/"
order: 137
---
...
<p><strong>哪里</strong></p>
<ul class="simple">
<li><p>TS = 时间戳</p></li>
<li><p>DIFF=与前一次测量的时间差</p></li>
<li><p>座椅=数据座椅</p></li>
<li><p>LE=1位置引擎已启用</p></li>
<li><p>MOV=1标签正在移动（由加速器传感器指示）</p></li>
</ul>
<p>示例3:</p>
...
<p><strong>哪里</strong></p>
<ul class="simple">
<li><p>｛0.25,0.01,0.06，R95=1.09｝-&gt;位置X、Y、Z和R95值的标准偏差</p></li>
<li><p>｛0.01｝在每个锚点处-&gt;距离测量的标准偏差。</p></li>
</ul>
<hr class="docutils">
</div>
<div class="section" id="lec">
<span id="id2"></span><h2>lec</h2>
<p>如果位置引擎以CSV格式启用，则显示到测距锚点的距离和位置。</p>
<p>示例:</p>
