...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/zh-cn/leaps-rtls/integration-guide/shell-api/uwbmac/"
order: 139
---
...
<p>示例 2:</p>
<p>如果设备为TN，UWB配置文件为0、1、2或3，则使用十六进制设置PANID掩码</p>
...
<div class="line"><code class="docutils literal notranslate"><span class="pre">0xFFF0</span></code>:接受从 <code class="docutils literal notranslate"><span class="pre">0x6660</span></code> 到 <code class="docutils literal notranslate"><span class="pre">0x666F</span></code> 的PANID。</div>
<div class="line">如果没有提供PANID掩码，则默认掩码为 <code class="docutils literal notranslate"><span class="pre">0xFFFF</span></code>。</div>
<div class="line"><em>Flags</em> bit 0 is set to 0: write to the environment.</div>
</div>
</div>
<p>示例 3:</p>
<p>或者，使用 <a class="reference external" href="https://www.freecodecamp.org/news/subnet-cheat-sheet-24-subnet-mask-30-26-27-29-and-other-ip-address-cidr-network-references/">CIDR表示法</a> 来设置PANID掩码</p>
...
<div class="admonition note">
<p class="admonition-title">注解</p>
<p><code class="docutils literal notranslate"><span class="pre">/12</span></code> 相当于掩码 <code class="docutils literal notranslate"><span class="pre">0xFFF0</span></code>。</p>
</div>
<hr class="docutils">
</div>
...
<p>设置每个超帧周期的脉冲。示例：50表示每50个超帧1个脉冲</p>
<p>示例:</p>
