...
sourceUrl: "https://docs.leapslabs.com/ja/pans-pro-rtls/integration-guide/api-commands/dwm-turn-off/"
order: 213
---
...
<p>タイプ 0x35 はコマンド dwm_int_cfg_get を意味します</p>
<dl class="c function">
...
<p>0x0F と入力すると、コマンド dwm_turn_off を意味します</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
