...
sourceUrl: "https://docs.leapslabs.com/ja/pans-pro-rtls/integration-guide/api-commands/dwm-uwb-cfg-set/"
order: 221
---
...
<li><p><strong>pg_delay</strong> -- 1 バイト (<em>送信機のキャリブレーション – パルス発生器の遅延</em>)</p></li>
<li><p><strong>tx_power</strong> -- 4 バイト (<em>TX 電力制御</em>)</p></li>
...
<p>タイプ 0x17 はコマンド dwm_uwb_cfg_set を意味します</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
