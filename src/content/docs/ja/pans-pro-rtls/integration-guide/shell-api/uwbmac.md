...
sourceUrl: "https://docs.leapslabs.com/ja/pans-pro-rtls/integration-guide/shell-api/uwbmac/"
order: 162
---
...
<p>パッシブ オフライン オプションを有効にし、ノードをリセットします。</p>
<p><strong>例:</strong></p>
...
<p>ノードをアンカー、アクティブとして構成し、ノードをリセットします。</p>
<p><strong>例:</strong></p>
...
<p>ノードをアンカー - イニシエーターとして構成し、アクティブにし、ノードをリセットします。</p>
<p><strong>例:</strong></p>
...
<p>ノードをタグとして構成し、アクティブにし、ノードをリセットします。</p>
<p><strong>例:</strong></p>
...
<p>ノードをタグ、アクティブ、低電力として構成し、ノードをリセットします。</p>
<p><strong>例:</strong></p>
...
<p>アンカー リストを表示します (出力はノード タイプに基づいて若干異なる場合があります)。</p>
<p><strong>例:</strong></p>
...
<p>ルートのリスト [ファームウェアが UWB ルーティング バックホールでコンパイルされている場合にのみ利用可能]］</p>
<p><strong>例:</strong></p>
...
<p>次のルートをリストします [ファームウェアが UWB ルーティング バックホールでコンパイルされている場合にのみ利用可能]</p>
<p><strong>例:</strong></p>
...
<thead>
<tr class="row-odd"><th class="head" colspan="2"><p><strong>統計を表示します</strong></p></th>
</tr>
</thead>
<tbody>
<tr class="row-even"><td><p><strong>統計</strong></p></td>
...
<tr class="row-odd"><td><p>再初期化</p></td>
<td><p>ノードの再初期化の数</p></td>
</tr>
<tr class="row-even"><td><p>twr_ok</p></td>
<td><p>成功したTWRサイクルの数</p></td>
</tr>
<tr class="row-odd"><td><p>twr_err</p></td>
<td><p>失敗した TWR の数サイクル</p></td>
</tr>
...
<p>バックホール経由で受信した IoT データの表示を切り替えます。</p>
<p>例:</p>
