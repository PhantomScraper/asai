...
sourceUrl: "https://docs.leapslabs.com/ja/pans-pro-rtls/integration-guide/shell-api/base/"
order: 156
---
...
<span id="pp-help"></span><h2>ヘルプ</h2>
<p>コマンド <code class="docutils literal notranslate"><span class="pre">?</span></code> と同様にヘルプを表示します。</p>
<p><strong>例:</strong></p>
...
<span id="pp-quit"></span><h2>終了</h2>
<p>コンパイルされている場合、シェルをオフにし、UART を API モードに切り替えます。</p>
<p><strong>例:</strong></p>
