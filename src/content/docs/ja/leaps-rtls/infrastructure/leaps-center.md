...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/infrastructure/leaps-center/"
order: 32
---
...
<p><a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> は、デバイス管理、ネットワーク管理、ネットワーク全体の位置情報と遠隔測定データの可視化を提供するウェブアプリケーションです。</p>
...
<li><p>The <a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> は <a class="reference external" href="https://mosquitto.org/">MQTT Broker</a> を介して <a class="reference internal" href="/docs/ja/leaps-rtls/infrastructure/leaps-server#leapsserver"><span class="std std-ref">LEAPS Server</span></a> と通信します。これは Linux または Windows プラットフォーム上でサービスとして動作します。</p></li>
</ul>
</div>
...
<p><a class="reference external" href="https://docs.docker.com/desktop/install/mac-install/">macOSにDocker Desktopをインストールする</a></p>
</div>
</div>
</div></blockquote>
...
<blockquote>
<div><ul class="simple">
<li><p><a class="reference internal" href="#configuration-files"><span class="std std-ref">設定ファイル</span></a> を含むleaps_centerディレクトリを作成します。</p>
<ul>
...
<li><p>または、 <a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> 設定パッケージをダウンロードすることもできます(<a class="reference external" href="https://drive.google.com/file/d/1T-TECozBs9O87w4sCUHM1bXtLkd6jvHM/view?usp=drive_link">LEAPS_CENTER_DOCKER.zip</a>)。</p></li>
</ul>
</div></blockquote>
...
<blockquote>
<div><ul class="simple">
<li><p><a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> 構成パッケージを解凍したディレクトリに移動します。</p></li>
</ul>
...
<li><p><a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> Dockerパッケージをインストールします。</p></li>
</ol>
<blockquote>
...
<li><p><a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> のインストールプロセスが開始されます。</p></li>
</ol>
<blockquote>
...
<li><p>Web ブラウザを開き、<a class="reference external" href="http://localhost:80">http://localhost:80</a>; と入力します。<a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> アプリケーションが Web ブラウザに読み込まれます。</p></li>
</ol>
<blockquote>
...
<p>これで、<a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> が PC にインストールされ、起動しました。</p>
</div>
</div>
<div class="section" id="configuration-files">
<span id="id1"></span><h2>設定ファイル</h2>
<ul>
...
<ul class="simple">
<li><p><a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> を起動するには、次のコマンドを実行します。<code class="docutils literal notranslate"><span class="pre">docker</span> <span class="pre">start</span> <span class="pre">leaps_center</span></code></p></li>
<li><p><a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> を停止するには、次のコマンドを実行します。<code class="docutils literal notranslate"><span class="pre">docker</span> <span class="pre">stop</span> <span class="pre">leaps_center</span></code></p></li>
<li><p><a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> を再起動します。<code class="docutils literal notranslate"><span class="pre">docker</span> <span class="pre">restart</span> <span class="pre">leaps_center</span></code></p></li>
<li><p><a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> を削除するには、次のコマンドを実行します。<code class="docutils literal notranslate"><span class="pre">docker</span> <span class="pre">rm</span> <span class="pre">--force</span> <span class="pre">leaps_center</span></code></p></li>
</ul>
</div>
...
<p>すべて入力したら、<span class="red-text">保存</span> ボタンをクリックして接続し、ネットワークIDを受け取ります。</p>
<blockquote>
...
<p>最後に <span class="red-text">テスト</span> ボタンをクリックして接続を確認し、 <span class="red-text">保存</span> ボタンをクリックして設定を保存します。</p>
</div></blockquote>
</div>
...
<p>入力が終わったら <span class="red-text">保存</span> ボタンをクリックして設定を保存します。 <span class="red-text">Visible</span> チェックボックスを使用すると、マップ上で可視性を有効にすることができます。</p>
...
<p>右下の <span class="red-text">Add</span> ボタンをクリックしてください。</p>
<a class="reference internal image-reference" href="../../../_images/lc_floor_plans_add.png"><img alt="../../../_images/lc_floor_plans_add.png" class="align-center" src="/docs-assets/ja/_images/lc_floor_plans_add.png" style="width: 1020.6px; height: 331.2px;"></a>
<p>それから対応するパラメータを入力し、<span class="red-text">保存</span> の設定を追加します。</p>
</div></blockquote>
</div>
...
<li><p><a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> はログイン後、およびユーザーが認証されていない場合にリダイレクトを実行するため、ユーザーのクライアントで "follow redirects" パラメータを適切に設定する必要があります。ログイン後のレスポンスコードは 302 ですが、ユーザーが認証されていない場合はステータスコードも 302 となるため、手動で処理する必要があります。ユーザーは REST サービスなどに対して任意のリクエストを実行できますが、レスポンスステータスコードが 200 でない場合は認証されません。</p></li>
</ol>
</div>
</li>
</ol>
...
<h2>トラブルシューティング</h2>
<ul class="simple">
<li><p>次のコマンド <code class="docutils literal notranslate"><span class="pre">docker</span> <span class="pre">restart</span> <span class="pre">leaps_center</span></code> を使用して、<a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> を再起動してください。</p></li>
<li><p><a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> の実行中にログを確認し、docker デスクトップを開いて leaps_center コンテナを選択してください。</p></li>
