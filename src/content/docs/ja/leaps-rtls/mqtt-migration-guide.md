...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/mqtt-migration-guide/"
order: 19
---
...
integrations from the <a class="reference internal" href="/docs/ja/pans-pro-rtls#pans-pro-rtls"><span class="std std-ref">PANS PRO RTLS</span></a> stack to the <a class="reference internal" href="/docs/ja/leaps-rtls#leaps-rtls"><span class="std std-ref">LEAPS RTLS</span></a> stack. Teams
...
<ul>
<li><p><a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-api#pans-mqtt-api"><span class="std std-ref">PANS PRO RTLS MQTT API</span></a></p></li>
<li><p><a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-connector#pans-mqtt-connector"><span class="std std-ref">PANS PRO RTLS MQTT Connector</span></a></p></li>
<li><p><a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-mqtt-message-reference"><span class="std std-ref">PANS PRO RTLS MQTT Message Reference</span></a></p></li>
</ul>
</li>
<li><p>LEAPS RTLS:</p>
<ul>
<li><p><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-api#leaps-mqtt-api"><span class="std std-ref">LEAPS RTLS MQTT API</span></a></p></li>
<li><p><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/base-mqtt-messages#leaps-base-mqtt-messages"><span class="std std-ref">LEAPS RTLS Base MQTT messages</span></a></p></li>
<li><p><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/leaps-mqtt-connector#leaps-mqtt-connector"><span class="std std-ref">LEAPS RTLS LEAPS MQTT Connector</span></a></p></li>
<li><p><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-mqtt-message-reference"><span class="std std-ref">LEAPS RTLS MQTT Message Reference</span></a></p></li>
</ul>
</li>
</ul>
<hr class="docutils">
...
<li><p><a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-servermessage"><span class="std std-ref">サーバーメッセージ</span></a> requests</p></li>
</ul>
</td>
<td><ul class="simple">
...
<td><p><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-server-request"><span class="std std-ref">leaps_api.server_request</span></a> (state, version, nodeList, request, networks)</p></td>
...
<td><p><a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-gatewaystatusandconfig"><span class="std std-ref">GatewayStatusAndConfig</span></a> (networkId, bridgeNodeId, configuration)</p></td>
<td><ul class="simple">
...
<td><ul class="simple">
<li><p><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-status"><span class="std std-ref">leaps_api.status</span></a></p></li>
<li><p><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-node-config"><span class="std std-ref">leaps_api.node_config</span></a></p></li>
</ul>
</td>
...
<td><ul class="simple">
<li><p><a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-nodestatusuplink"><span class="std std-ref">NodeStatusUplink</span></a></p></li>
<li><p><a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-nodeconfiguration"><span class="std std-ref">NodeConfiguration</span></a></p></li>
</ul>
</td>
<td><ul class="simple">
...
<td><p>Map <cite>nodeType</cite> into <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#anchor-config"><span class="std std-ref">anchor_config</span></a>/<a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#tag-config"><span class="std std-ref">tag_config</span></a>; remove redundant <cite>networkId</cite>.</p></td>
</tr>
...
<td><ul class="simple">
<li><p><a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-nodedatauplink"><span class="std std-ref">NodeDataUplink</span></a> with Base64 payloads with optional <cite>superFrameNumber</cite></p></li>
<li><p><a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-nodedatadownlink"><span class="std std-ref">NodeDataDownlink</span></a> with Base64 payloads with optional <cite>overwrite</cite></p></li>
<li><p><a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-nodeserviceuplink"><span class="std std-ref">NodeServiceUplink</span></a> / <a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-nodeservicedownlink"><span class="std std-ref">NodeServiceDownlink</span></a> TLV messages</p></li>
</ul>
</td>
<td><ul class="simple">
...
<td><ul class="simple">
<li><p><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-user-data"><span class="std std-ref">leaps_api.user_data</span></a></p></li>
<li><p><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-service-data"><span class="std std-ref">leaps_api.service_data</span></a></p></li>
</ul>
</td>
...
<td><p><a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-nodelocationuplink"><span class="std std-ref">NodeLocationUplink</span></a> (<a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-position"><span class="std std-ref">位置</span></a>, superFrameNumber)</p></td>
<td><p><cite>{prefix}/{networkId}/node/uplink/location/{deviceId}</cite> (QoS 0 / retained ✗)</p></td>
<td><p><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-location"><span class="std std-ref">leaps_api.location</span></a> (<a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#node-location"><span class="std std-ref">ノード位置</span></a>, statistics)</p></td>
...
disconnect (See <a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-connector#pp-uplink"><span class="std std-ref">reference</span></a>).</p></li>
...
(See <a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-connector#pp-downlink"><span class="std std-ref">reference</span></a>).</p></li>
</ul>
</li>
...
(See <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/base-mqtt-messages#lr-uplink"><span class="std std-ref">reference1</span></a>
and <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-server-status"><span class="std std-ref">reference2</span></a>).</p></li>
...
(See <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/base-mqtt-messages#lr-downlink"><span class="std std-ref">reference</span></a>).</p></li>
</ul>
</li>
...
(See <a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-connector#pp-gatewaystatusandconfig"><span class="std std-ref">reference</span></a>).</p></li>
...
(See <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/leaps-mqtt-connector#lr-uplink-gw"><span class="std std-ref">reference</span></a>).</p></li>
...
(<a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/leaps-mqtt-connector#lr-configuration-message"><span class="std std-ref">reference1</span></a>
and
<a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-node-config"><span class="std std-ref">reference2</span></a>).</p></li>
</ul>
</li>
<li><p><strong>Translation steps:</strong></p>
<ol class="arabic simple">
...
(See <a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-connector#pp-nodestatusuplink"><span class="std std-ref">reference</span></a>).</p></li>
...
(See <a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-connector#pp-nodestatusuplink"><span class="std std-ref">reference1</span></a>
and <a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-connector#pp-nodeconfigdownlink"><span class="std std-ref">reference2</span></a>).</p></li>
</ul>
</li>
<li><p><strong>LEAPS topics:</strong></p>
<ul class="simple">
...
(See <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/leaps-mqtt-connector#lr-configuration-message"><span class="std std-ref">reference</span></a>).</p></li>
</ul>
</li>
<li><p><strong>Translation steps:</strong></p>
<ol class="arabic simple">
...
(See <a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-connector#pp-superframenumber"><span class="std std-ref">reference</span></a>).</p></li>
...
(See <a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-connector#pp-superframenumber"><span class="std std-ref">reference1</span></a>,
and <a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-connector#pp-nodeconfigdownlink"><span class="std std-ref">reference2</span></a>).</p></li>
</ul>
</li>
<li><p><strong>LEAPS topics:</strong></p>
...
(See <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/leaps-mqtt-connector#lr-data-message-01"><span class="std std-ref">reference1</span></a>
and <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-user-data"><span class="std std-ref">reference2</span></a>).</p></li>
...
(See <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/leaps-mqtt-connector#lr-service-message-01"><span class="std std-ref">reference</span></a>).</p></li>
</ul>
</li>
<li><p><strong>Translation steps:</strong></p>
<ol class="arabic simple">
...
(See <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#tag-config"><span class="std std-ref">tag_config</span></a>).</p></li>
...
(See <a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-connector#pp-uplink-location"><span class="std std-ref">reference</span></a>).</p></li>
...
(See <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/leaps-mqtt-connector#lr-uplink-location"><span class="std std-ref">reference</span></a>).</p></li>
<li><p><strong>Translation steps:</strong></p>
<ol class="arabic simple">
...
<tbody>
<tr class="row-even"><td><p>Server lifecycle</p></td>
<td><p><a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-connector#pans-mqtt-connector"><span class="std std-ref">MQTT コネクタ</span></a></p></td>
<td><p><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/base-mqtt-messages#leaps-base-mqtt-messages"><span class="std std-ref">基本 MQTT メッセージ</span></a></p></td>
</tr>
<tr class="row-odd"><td><p>Gateway status/config</p></td>
<td><p><a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-connector#pans-mqtt-connector"><span class="std std-ref">MQTT コネクタ</span></a></p></td>
<td><p><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/leaps-mqtt-connector#leaps-mqtt-connector"><span class="std std-ref">LEAPS MQTT コネクタ</span></a></p></td>
</tr>
<tr class="row-even"><td><p>Node status/config</p></td>
<td><p><a class="reference internal" href="/docs/ja/pans-pro-rtls/integration-guide/mqtt-connector#pans-mqtt-connector"><span class="std std-ref">MQTT コネクタ</span></a></p></td>
<td><p><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/leaps-mqtt-connector#leaps-mqtt-connector"><span class="std std-ref">LEAPS MQTT コネクタ</span></a></p></td>
