---
title: "leaps_label_read"
lang: ja
slug: "leaps-rtls/integration-guide/api-commands/leaps-label-read"
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/integration-guide/api-commands/leaps-label-read/"
order: 269
---
...
<!-- <div class="wy-alert wy-alert-warning">
  ...
  <div class="section" id="leaps-label-read">
<span id="id1"></span><h1>leaps_label_read</h1>
...
<li><p class="sd-card-text">データ: 0 ～ 10 バイト (<em>ラベル</em>)</p></li>
</ul>
</div>
</div>
</div>
...
<p>0x1C と入力すると、コマンド Leaps_label_read を意味します</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 13%">
<col style="width: 14%">
...
<tr class="row-odd"><td><p>最大 10 バイト</p></td>
</tr>
