---
title: "leaps_panid_set"
lang: ja
slug: "leaps-rtls/integration-guide/api-commands/leaps-panid-set"
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/integration-guide/api-commands/leaps-panid-set/"
order: 229
---
...
<!-- <div class="wy-alert wy-alert-warning">
  ...
  <div class="section" id="leaps-panid-set">
<span id="id1"></span><h1>leaps_panid_set</h1>
<p>ノードの UWB ネットワーク ID と、近隣ネットワークのグループ内 ID を設定します。ID は不揮発性メモリに保存されます。</p>
<hr class="docutils">
...
<p>0x2E と入力すると、コマンド Leaps_panid_set を意味します</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
