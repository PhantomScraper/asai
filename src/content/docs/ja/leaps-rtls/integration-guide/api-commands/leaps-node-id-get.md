...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/integration-guide/api-commands/leaps-node-id-get/"
order: 228
---
...
<p>ノードの完全な UWB アドレスを一意の 64 ビット番号として取得します。</p>
<hr class="docutils">
...
<li><p class="sd-card-text">node_id: 8 バイト リトル エンディアン (<em>UWB ノード アドレス/ID</em>)</p></li>
</ul>
</div>
</div>
</div>
...
<p>0x30 と入力すると、コマンド Leaps_node_id_get を意味します</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 20%">
<col style="width: 16%">
...
<tr class="row-odd"><td><p>リトルエンディアンで8バイト</p></td>
</tr>
