...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/integration-guide/api-commands/leaps-stats-get/"
order: 283
---
...
<li><p class="sd-card-text">統計：204バイト</p></li>
</ul>
</div>
</div>
</div>
...
<thead>
<tr class="row-odd"><th class="head" colspan="3"><p>統計（順番）</p></th>
</tr>
</thead>
<tbody>
<tr class="row-even"><td rowspan="2"><p>タイプ</p></td>
<td rowspan="2"><p>サイズ（バイト）</p></td>
<td rowspan="2"><p>名前</p></td>
</tr>
<tr class="row-odd"></tr>
...
<p>タイプ 0x96 はコマンド leaps_stats_get を意味します</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 11%">
<col style="width: 11%">
...
<tr class="row-odd"><td><p>統計（204バイト）</p></td>
</tr>
...
<p>タイプ 0x40 はステータスコード タイプ 0x80 は統計</p>
</div>
