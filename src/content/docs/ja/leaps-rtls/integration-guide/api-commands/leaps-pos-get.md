...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/integration-guide/api-commands/leaps-pos-get/"
order: 227
---
...
入力</div>
<ul class="simple">
<li><p class="sd-card-text">(なし)</p></li>
</ul>
</div>
</div>
</div>
...
<li><p class="sd-card-text"><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/api-generic-data-types#position"><span class="std std-ref">位置</span></a></p></li>
</ul>
</div>
</div>
</div>
...
<p>タイプ 0x02 はコマンド Leaps_pos_get を意味します</p>
<table class="custom-table docutils align-default">
<thead>
...
<div class="line">もう少しで</div>
<div class="line">エンディアンは</div>
<div class="line">x 座標</div>
<div class="line">ミリメートル単位</div>
...
<div class="line">品質</div>
<div class="line">要素に含める</div>
<div class="line">パーセント (0-100)</div>
<div class="line"><br></div>
<div class="line"><br></div>
<div class="line"><br></div>
</div>
