---
title: "leaps_label_write"
lang: ja
slug: "leaps-rtls/integration-guide/api-commands/leaps-label-write"
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/integration-guide/api-commands/leaps-label-write/"
order: 270
---
...
<!-- <div class="wy-alert wy-alert-warning">
  ...
  <div class="section" id="leaps-label-write">
<span id="id1"></span><h1>leaps_label_write</h1>
<p>ラベルをノードに書き込みます。</p>
<hr class="docutils">
...
入力</div>
<ul class="simple">
<li><p class="sd-card-text">ラベル</p></li>
<li><p class="sd-card-text">len</p></li>
<li><p class="sd-card-text">データ: 最大 10 バイト (<em>書き込まれるラベルのバイト数</em>)</p></li>
</ul>
</div>
</div>
</div>
...
<tr class="row-odd"><td><p>ラベル、最大 10 バイト</p></td>
</tr>
...
<p>0x1D と入力すると、コマンド Leaps_label_write を意味します</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
