...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/integration-guide/api-commands/leaps-turn-off/"
order: 265
---
...
<p>デバイスの電源をオフにします。再び電源を入れるには、デバイスの電源を再投入するか、ボタンを使用してリセットする必要があります。</p>
<hr class="docutils">
...
<p>0x0F と入力すると、コマンド Leaps_turn_off を意味します</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 26%">
<col style="width: 26%">
