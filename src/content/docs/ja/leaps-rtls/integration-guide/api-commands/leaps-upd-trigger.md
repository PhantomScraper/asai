...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/integration-guide/api-commands/leaps-upd-trigger/"
order: 246
---
...
<p>デバイスが手動トリガー モードのときに位置測定をトリガーします。</p>
<hr class="docutils">
...
<p>タイプ 0x8B はコマンド Leaps_upd_trigger を意味します</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
