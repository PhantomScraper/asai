...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/integration-guide/api-commands/leaps-enc-key-clear/"
order: 262
---
...
<p>暗号化キーをクリアし、暗号化オプションが有効になっている場合は無効にします。キーが設定されていない場合は何も行いません。</p>
...
<p>タイプ 0x3D はコマンド Leaps_enc_key_clear を意味します</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
