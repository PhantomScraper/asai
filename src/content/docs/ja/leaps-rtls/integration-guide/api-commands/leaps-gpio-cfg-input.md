...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/integration-guide/api-commands/leaps-gpio-cfg-input/"
order: 244
---
...
入力</div>
<ul class="simple">
<li><p class="sd-card-text"><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/api-generic-data-types#gpioidx"><span class="std std-ref">gpio_idx</span></a>: 8 ビット符号なし整数 (許可される値については前の章を参照)</p></li>
<li><p class="sd-card-text">gpio_pull: 8 ビット符号なし整数 (0 プルなし、1 プルダウン、3 プルアップ*)</p></li>
</ul>
</div>
</div>
</div>
...
<p>タイプ 0x29 はコマンド Leaps_gpio_cfg_input を意味します</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
