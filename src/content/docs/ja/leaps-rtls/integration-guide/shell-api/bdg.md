...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/integration-guide/shell-api/bdg/"
order: 143
---
...
<p>When executed on the ESP32, the <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/shell-api/api#tlv"><span class="std std-ref">tlv</span></a> command reports ESP32-related values. In contrast, the utlv command retrieves values originating from the UWB module.</p>
<blockquote>
