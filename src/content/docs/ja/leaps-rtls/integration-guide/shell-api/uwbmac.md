...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/integration-guide/shell-api/uwbmac/"
order: 139
---
...
<p>例 2:</p>
<p>デバイスが TN で UWB プロファイルが 0、1、2、または 3 の場合、PANID マスクをヘキサッド</p>
...
<div class="line"><code class="docutils literal notranslate"><span class="pre">0xFFF0</span></code> を使用して設定します: PANID を <code class="docutils literal notranslate"><span class="pre">0x6660</span></code> から <code class="docutils literal notranslate"><span class="pre">0x666F</span></code> まで受け入れます。</div>
<div class="line">PANIDマスクが指定されていない場合、デフォルトのマスクは <code class="docutils literal notranslate"><span class="pre">0xFFFF</span></code> です。</div>
<div class="line"><em>Flags</em> bit 0 is set to 0: write to the environment.</div>
</div>
</div>
<p>例 3:</p>
<p>あるいは、<a class="reference external" href="https://www.freecodecamp.org/news/subnet-cheat-sheet-24-subnet-mask-30-26-27-29-and-other-ip-address-cidr-network-references/">CIDR notation</a> を使ってPANID MASKを設定する。</p>
...
<div class="admonition note">
<p class="admonition-title">注釈</p>
<p><code class="docutils literal notranslate"><span class="pre">/12</span></code> はマスク <code class="docutils literal notranslate"><span class="pre">0xFFF0</span></code> と等価である。</p>
</div>
<hr class="docutils">
</div>
...
<p>スーパーフレームサイクルごとのパルス数を設定。例：50は50スーパーフレームに1パルスを意味します。</p>
<p>例:</p>
