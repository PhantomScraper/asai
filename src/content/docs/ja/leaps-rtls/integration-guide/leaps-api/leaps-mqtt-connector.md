---
title: "LEAPS MQTT コネクタ"
lang: ja
slug: "leaps-rtls/integration-guide/leaps-api/leaps-mqtt-connector"
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/integration-guide/leaps-api/leaps-mqtt-connector/"
order: 78
---
...
<span id="id1"></span><h1>LEAPS MQTT コネクタ</h1>
<p>次の章では、LEAPS MQTT コネクタに固有のメッセージについて説明します。アップリンク トピックの Pan ID (ネットワーク ID) はオプションであり、構成設定を調整することで除外できます。</p>
<hr class="docutils">
<div class="section" id="uplink">
<span id="lr-uplink-gw"></span><h2>アップリンク</h2>
...
<thead>
<tr class="row-odd"><th class="head"><p>トピック</p></th>
...
<div class="line">ゲートウェイのステータス メッセージ。</div>
<div class="line"><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-status"><span class="std std-ref">leaps_api.status</span></a> を参照してください。</div>
</div>
<ul class="simple">
<li><p>保持 = 偽</p></li>
<li><p>qos = 1</p></li>
...
<div class="line">トピック: Leaps/0001/gateway/uplink/status/deca1e1cef720714</div>
</div>
...
<div class="line"><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-node-config"><span class="std std-ref">leaps_api.node_config</span></a> を参照してください</div>
</div>
<ul class="simple">
<li><p>保持 = 偽</p></li>
<li><p>qos = 1</p></li>
...
<td><div class="line-block">
<div class="line">デバイス ステータス。このトピックは読み取り専用です。</div>
<div class="line"><a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-status"><span class="std std-ref">leaps_api.status</span></a> を参照してください。</div>
</div>
<ul class="simple">
<li><p>保持 = 偽</p></li>
...
<td><blockquote>
<div><p>Refer to <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-user-data"><span class="std std-ref">leaps_api.user_data</span></a></p>
<ul class="simple">
<li><p>保持 = 偽</p></li>
<li><p>qos = 1</p></li>
</ul>
...
<td><p>Refer to <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-service-data"><span class="std std-ref">leaps_api.service_data</span></a></p>
<ul class="simple">
<li><p>保持 = 偽</p></li>
<li><p>qos = 1</p></li>
</ul>
...
<td><p>Refer to <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-location"><span class="std std-ref">leaps_api.location</span></a></p>
<ul class="simple">
<li><p>保持 = 偽</p></li>
<li><p>qos = 0</p></li>
</ul>
...
<td><p>Refer to <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-tdoa-external-le"><span class="std std-ref">leaps_api.tdoa_external_le</span></a></p>
<ul class="simple">
<li><p>保持 = 偽</p></li>
<li><p>qos = 0</p></li>
</ul>
...
<td><div class="line-block">
<div class="line">Refer to <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-service-data"><span class="std std-ref">leaps_api.service_data</span></a></div>
</div>
<div class="line-block">
<div class="line">例:</div>
...
<td><div class="line-block">
<div class="line">Refer to <a class="reference internal" href="/docs/ja/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-user-data"><span class="std std-ref">leaps_api.user_data</span></a></div>
</div>
<div class="line-block">
<div class="line">例:</div>
