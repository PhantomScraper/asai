...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/quick-start-guide/infrastructure-rpi/"
order: 65
---
...
<li><p>この例では、ID <code class="docutils literal notranslate"><span class="pre">0x83A2</span></code> のゲートウェイ ボードに接続する必要があります。</p></li>
</ul>
<div class="figure align-center">
