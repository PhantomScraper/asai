...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/ja/leaps-rtls/quick-start-guide/leaps_vmware/"
order: 63
---
...
<blockquote>
<div><ul class="simple">
<li><p>インポートが完了したら、インポートされた仮想マシンを選択し、<span class="red-text">開始</span> ボタンをクリックして起動します。</p></li>
</ul>
</div></blockquote>
<div class="figure align-center">
