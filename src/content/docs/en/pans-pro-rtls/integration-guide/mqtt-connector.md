...
sourceUrl: "https://docs.leapslabs.com/pans-pro-rtls/integration-guide/mqtt-connector/"
order: 74
---
...
<span id="pans-mqtt-connector"></span><h1>MQTT Connector</h1>
<p>Following chapter describes messages specific to MQTT Connector.
The Pan ID (network ID) in the uplink topics is optional and can be excluded by adjusting the configuration settings.</p>
<hr class="docutils">
<div class="section" id="uplink">
<span id="pp-uplink"></span><h2>Uplink</h2>
...
<div class="line">Last Will and testament of Leaps Server. Empty message is
published when the server gets disconnected from the broker.</div>
</div>
<ul class="simple">
<li><p>retained = true</p></li>
<li><p>qos = 1</p></li>
</ul>
</td>
</tr>
...
<div class="line">See <a class="reference internal" href="/docs/en/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-gatewaystatusandconfig"><span class="std std-ref">GatewayStatusAndConfig</span></a>.</div>
</div>
<ul class="simple">
<li><p>retained = true</p></li>
<li><p>qos = 1</p></li>
...
uplink/status</p></td>
<td><p>Device status. This topic is
read only. See
<a class="reference internal" href="/docs/en/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-nodestatusuplink"><span class="std std-ref">NodeStatusUplink</span></a>.</p>
<ul class="simple">
<li><p>retained = true</p></li>
<li><p>qos = 1</p></li>
</ul>
...
uplink/config</p></td>
<td><blockquote>
<div><p>See <a class="reference internal" href="/docs/en/pans-pro-rtls/integration-guide/mqtt-message-reference#nodeconfiguplink"><span class="std std-ref">NodeConfigUplink</span></a>.</p>
<ul class="simple">
<li><p>retained = true</p></li>
<li><p>qos = 1</p></li>
</ul>
...
<td><blockquote>
<div><p>See <a class="reference internal" href="/docs/en/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-nodelocationuplink"><span class="std std-ref">NodeLocationUplink</span></a>.</p>
<ul class="simple">
<li><p>retained = true</p></li>
<li><p>qos = 0</p></li>
</ul>
...
<span id="pp-downlink"></span><h2>Downlink</h2>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 34%">
<col style="width: 66%">
...
<tbody>
<tr class="row-even"><td><p>{prefix}/server</p></td>
<td><p>Request to the LEAPS Server.
See <a class="reference internal" href="/docs/en/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-servermessage"><span class="std std-ref">ServerMessage</span></a>.</p>
<div class="line-block">
<div class="line"><strong>Example</strong>:</div>
...
ceId}/downlink</p></td>
<td><p>See <a class="reference internal" href="/docs/en/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-gatewaystatusandconfig"><span class="std std-ref">GatewayStatusAndConfig</span></a>.</p>
<div class="line-block">
<div class="line"><strong>Example</strong>:</div>
<div class="line">topic:
...
<td><p>See <a class="reference internal" href="/docs/en/pans-pro-rtls/integration-guide/mqtt-message-reference#nodeconfigdownlink"><span class="std std-ref">NodeConfigDownlink</span></a>.</p>
<div class="line-block">
<div class="line"><strong>Example</strong>:</div>
<div class="line">topic:
...
<td><p>See <a class="reference internal" href="/docs/en/pans-pro-rtls/integration-guide/mqtt-message-reference#pans-nodeservicedownlink"><span class="std std-ref">NodeServiceDownlink</span></a>.</p>
<div class="line-block">
<div class="line"><strong>Example</strong>:</div>
