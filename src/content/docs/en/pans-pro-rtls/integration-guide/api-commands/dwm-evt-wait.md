...
sourceUrl: "https://docs.leapslabs.com/pans-pro-rtls/integration-guide/api-commands/dwm-evt-wait/"
order: 182
---
...
<p>Used to wait for an event from the DWM module. First, the user must register for the event by <a class="reference internal" href="/docs/en/pans-pro-rtls/integration-guide/api-commands/dwm-evt-listener-register#dwm-evt-listener-register"><span class="std std-ref">dwm_evt_listener_register</span></a>.
If the listener is registered and <a class="reference internal" href="#dwm-evt-wait"><span class="std std-ref">dwm_evt_wait</span></a> is not used to consume events, the event buffer will overflow.
The <a class="reference internal" href="#dwm-evt-wait"><span class="std std-ref">dwm_evt_wait</span></a> will block and sleep until next event.</p>
<p>Events that the user can wait for:</p>
<ul class="simple">
...
<li><p><strong>output</strong> – <a class="reference internal" href="/docs/en/pans-pro-rtls/integration-guide/generic-api-information#pans-statuscode"><span class="std std-ref">Status code</span></a>, evt</p></li>
