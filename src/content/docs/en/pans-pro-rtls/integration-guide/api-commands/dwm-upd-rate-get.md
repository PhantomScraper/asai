...
sourceUrl: "https://docs.leapslabs.com/pans-pro-rtls/integration-guide/api-commands/dwm-upd-rate-get/"
order: 215
---
...
<p>Gets the position update rate.</p>
<dl class="c function">
...
<li><p><strong>output</strong> – <a class="reference internal" href="/docs/en/pans-pro-rtls/integration-guide/generic-api-information#pans-statuscode"><span class="std std-ref">Status code</span></a>, update_rate, update_rate_stationary</p></li>
...
<p>Type 0x04 means command dwm_upd_rate_get</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 17%">
<col style="width: 17%">
...
<div class="line">Type 0x45 means update rate (normal and stationary)</div>
