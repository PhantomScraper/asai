...
sourceUrl: "https://docs.leapslabs.com/pans-pro-rtls/integration-guide/api-commands/dwm-label-write/"
order: 197
---
...
<p>Writes a label to the node.</p>
<dl class="c function">
...
<li><p><strong>input</strong> – label, len</p></li>
<li><p><strong>data</strong> – 16 bytes max (<em>the label bytes to be written</em>)</p></li>
<li><p><strong>len</strong> – 1 byte (<em>label length, 16 max</em>)</p></li>
...
<p>Type 0x1D means command dwm_label_write</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
