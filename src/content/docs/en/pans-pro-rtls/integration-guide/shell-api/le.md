...
sourceUrl: "https://docs.leapslabs.com/pans-pro-rtls/integration-guide/shell-api/le/"
order: 161
---
...
<p>Shows distances to ranging anchors and the position if the location engine is enabled.</p>
...
<p>Shows distances to ranging anchors and the position if the  location engine is enabled in CSV format.</p>
<p><strong>Example:</strong></p>
...
<p>Shows position in CSV format.</p>
<p><strong>Example:</strong></p>
