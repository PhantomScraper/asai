...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/leaps-rtls/infrastructure/leaps-center/"
order: 32
---
...
<p><a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> is a web application that provides device management, network management, and visualization of location and telemetry data for the whole network.</p>
...
<blockquote>
<div><ul class="simple">
<li><p>Create the leaps_center directory containing the <a class="reference internal" href="#configuration-files"><span class="std std-ref">Configuration files</span></a></p>
<ul>
...
<li><p>Or you can download the <a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> configuration package (<a class="reference external" href="https://drive.google.com/file/d/1T-TECozBs9O87w4sCUHM1bXtLkd6jvHM/view?usp=drive_link">LEAPS_CENTER_DOCKER.zip</a>).</p></li>
</ul>
</div></blockquote>
...
<blockquote>
<div><ul class="simple">
<li><p>Navigate to the directory where you extracted from the <a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> configuration package.</p></li>
</ul>
...
<li><p>Install the <a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> Docker packages, run:</p></li>
</ol>
<blockquote>
...
<li><p>The <a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> installation process will begin.</p></li>
</ol>
<blockquote>
...
<li><p>Open a web browser and enter the following <a class="reference external" href="http://localhost:80">http://localhost:80</a>; The <a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> application will load in a web browser.</p></li>
</ol>
<blockquote>
...
<p>So, you have successfully installed and started <a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> on your PC.</p>
</div>
</div>
<div class="section" id="configuration-files">
<span id="id1"></span><h2>Configuration files</h2>
<ul>
...
<ul class="simple">
<li><p>Start <a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a>, run: <code class="docutils literal notranslate"><span class="pre">docker</span> <span class="pre">start</span> <span class="pre">leaps_center</span></code></p></li>
<li><p>Stop <a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a>, run: <code class="docutils literal notranslate"><span class="pre">docker</span> <span class="pre">stop</span> <span class="pre">leaps_center</span></code></p></li>
<li><p>Restart <a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a>, run: <code class="docutils literal notranslate"><span class="pre">docker</span> <span class="pre">restart</span> <span class="pre">leaps_center</span></code></p></li>
<li><p>Remove <a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a>, run <code class="docutils literal notranslate"><span class="pre">docker</span> <span class="pre">rm</span> <span class="pre">--force</span> <span class="pre">leaps_center</span></code></p></li>
</ul>
</div>
...
<ul class="simple">
<li><p>Use the following command <code class="docutils literal notranslate"><span class="pre">docker</span> <span class="pre">restart</span> <span class="pre">leaps_center</span></code> to restart <a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a>.</p></li>
<li><p>Check the logs when <a class="reference internal" href="#leapscenter"><span class="std std-ref">LEAPS Center</span></a> is running, open the docker desktop and select the leaps_center container.</p></li>
