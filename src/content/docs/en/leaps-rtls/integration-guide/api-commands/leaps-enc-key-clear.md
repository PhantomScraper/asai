---
title: "leaps_enc_key_clear"
lang: en
slug: "leaps-rtls/integration-guide/api-commands/leaps-enc-key-clear"
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/leaps-rtls/integration-guide/api-commands/leaps-enc-key-clear/"
order: 263
---
...
<!-- <div class="wy-alert wy-alert-warning">
  ...
  <div class="section" id="leaps-enc-key-clear">
<span id="id1"></span><h1>leaps_enc_key_clear</h1>
<p>Clears the encryption key and disables encryption option if enabled.
Does nothing if the key is not set.</p>
...
milliseconds! Requires reset for new configuration to take effect.</p>
<hr class="docutils">
...
<p>Type 0x3D means command leaps_enc_key_clear</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
