...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/leaps-rtls/integration-guide/api-commands/leaps-label-read/"
order: 270
---
...
<li><p class="sd-card-text">data: 0 -10 bytes (<em>the label</em>)</p></li>
</ul>
</div>
</div>
</div>
...
<p>Type 0x1C means command leaps_label_read</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 13%">
<col style="width: 14%">
...
<tr class="row-odd"><td><p>max 10 bytes</p></td>
</tr>
