---
title: "leaps_turn_off"
lang: en
slug: "leaps-rtls/integration-guide/api-commands/leaps-turn-off"
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/leaps-rtls/integration-guide/api-commands/leaps-turn-off/"
order: 266
---
...
<!-- <div class="wy-alert wy-alert-warning">
  ...
  <div class="section" id="leaps-turn-off">
<span id="id1"></span><h1>leaps_turn_off</h1>
<p>Turn off the device. The device needs to be repower to or reset using
the button to turn on again.</p>
<hr class="docutils">
...
<p>Type 0x0F means command leaps_turn_off</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 26%">
<col style="width: 26%">
