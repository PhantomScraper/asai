...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/leaps-rtls/integration-guide/api-commands/leaps-panid-get/"
order: 231
---
...
<p>Get UWB network identifier as well as the ingroup IDs of the neighbor networks.</p>
<hr class="docutils">
...
<p>Type 0x2F means command leaps_panid_get</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 14%">
<col style="width: 19%">
