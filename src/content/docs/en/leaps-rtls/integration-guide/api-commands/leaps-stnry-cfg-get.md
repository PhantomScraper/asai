...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/leaps-rtls/integration-guide/api-commands/leaps-stnry-cfg-get/"
order: 269
---
...
<p>Reads configuration of the stationary mode which is used by the tag
node. The configuration can be read even if stationary detection is
disabled (see <a class="reference internal" href="/docs/en/leaps-rtls/integration-guide/api-commands/leaps-cfg-tag-set#leaps-cfg-tag-set"><span class="std std-ref">leaps_cfg_tag_set</span></a>).</p>
<hr class="docutils">
...
<p>Type 0x12 means command leaps_stnry_cfg_get</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 16%">
<col style="width: 19%">
...
<p>Type 0x4A means stationary sensitivity</p>
</div>
