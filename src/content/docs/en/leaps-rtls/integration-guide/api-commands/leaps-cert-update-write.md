...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/leaps-rtls/integration-guide/api-commands/leaps-cert-update-write/"
order: 282
---
...
<p>The size and the offset of the data already written to the flash by the update procedure so far are returned as a response on each call to leaps_cert_update_write until the update is completed.</p>
<hr class="docutils">
...
<li><p class="sd-card-text">data: from 4 to 240 bytes (<em>Certificate data chunk currently being uploaded, up to 240 bytes.</em>)</p></li>
</ul>
</div>
</div>
</div>
...
<p>Type 0x3B (59 dec) means command leaps_cert_update_write</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 14%">
<col style="width: 14%">
