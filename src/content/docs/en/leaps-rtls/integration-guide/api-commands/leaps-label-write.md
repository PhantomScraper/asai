...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/leaps-rtls/integration-guide/api-commands/leaps-label-write/"
order: 271
---
...
Input</div>
<ul class="simple">
<li><p class="sd-card-text">label</p></li>
<li><p class="sd-card-text">len</p></li>
<li><p class="sd-card-text">data: 10 bytes max (<em>the label bytes to be written</em>)</p></li>
</ul>
</div>
</div>
</div>
...
<tr class="row-odd"><td><p>label, 10
bytes max</p></td>
</tr>
...
<p>Type 0x1D means command leaps_label_write</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
