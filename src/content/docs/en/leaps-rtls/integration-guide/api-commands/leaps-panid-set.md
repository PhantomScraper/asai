...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/leaps-rtls/integration-guide/api-commands/leaps-panid-set/"
order: 230
---
...
<p>Sets UWB network identifier for the node as well as the ingroup IDs of
the neighbor networks. The IDs are stored in non-volatile memory.</p>
<hr class="docutils">
...
<p>Type 0x2E means command leaps_panid_set</p>
<table class="custom-table docutils align-default">
<colgroup>
<col style="width: 33%">
<col style="width: 33%">
