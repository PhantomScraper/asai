...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/leaps-rtls/integration-guide/shell-api/base/"
order: 135
---
...
<span id="id2"></span><h2>help</h2>
<p>Displays help, same as command “?”.</p>
<p>Example:</p>
...
<span id="id3"></span><h2>quit</h2>
<p>Turns off shell and switches UART into API mode if compiled.</p>
<p>Example:</p>
