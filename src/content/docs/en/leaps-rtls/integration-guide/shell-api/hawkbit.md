...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/leaps-rtls/integration-guide/shell-api/hawkbit/"
order: 143
---
...
<p>Check the configuration again with the <a class="reference internal" href="/docs/en/leaps-rtls/integration-guide/shell-api/sys#si"><span class="std std-ref">si</span></a> command.</p>
</div></blockquote>
<hr class="docutils">
</div>
