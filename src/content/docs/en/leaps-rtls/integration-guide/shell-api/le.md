...
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/leaps-rtls/integration-guide/shell-api/le/"
order: 138
---
...
<p>Show distances to ranging anchors and the position if location engine is
enabled.</p>
<p>Example 1:</p>
...
<ul class="simple">
<li><p>TS = Timestamp</p></li>
<li><p>DIFF = time difference to the previous measurement</p></li>
<li><p>SEAT = Data seat</p></li>
<li><p>LE = 1 Location engine enabled</p></li>
<li><p>MOV = 1 Tag is moving (indicated by the accelerator sensor)</p></li>
</ul>
<p>Example 3:</p>
...
<p><strong>Where</strong></p>
<ul class="simple">
<li><p>{0.25,0.01,0.06,R95=1.09} -&gt; standard deviation for X,Y,Z and R95 value for the position</p></li>
<li><p>{0.01} at each of the Anchor -&gt; standard deviations of the distance measurement.</p></li>
</ul>
<hr class="docutils">
</div>
...
<p>Show position in CSV format.</p>
<p>Example:</p>
...
<p>Show position in JSON format.</p>
<p>Example:</p>
