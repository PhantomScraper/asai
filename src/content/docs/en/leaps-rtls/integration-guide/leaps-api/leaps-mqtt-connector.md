---
title: "LEAPS MQTT Connector"
lang: en
slug: "leaps-rtls/integration-guide/leaps-api/leaps-mqtt-connector"
section: "leaps-rtls"
sourceUrl: "https://docs.leapslabs.com/leaps-rtls/integration-guide/leaps-api/leaps-mqtt-connector/"
order: 78
---
...
<span id="id1"></span><h1>LEAPS MQTT Connector</h1>
<p>Following chapter describes messages specific to LEAPS MQTT connector. The Pan ID (network ID) in the uplink topics is optional and can be excluded by adjusting the configuration settings.</p>
<hr class="docutils">
<div class="section" id="uplink">
<span id="lr-uplink-gw"></span><h2>Uplink</h2>
...
<div class="line">Gateway status message.</div>
<div class="line">Refer to <a class="reference internal" href="/docs/en/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-status"><span class="std std-ref">leaps_api.status</span></a></div>
</div>
<ul class="simple">
...
<td><div class="line-block">
<div class="line">Device configuration message.</div>
<div class="line">Refer to <a class="reference internal" href="/docs/en/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-node-config"><span class="std std-ref">leaps_api.node_config</span></a></div>
</div>
<ul class="simple">
<li><p>retained = false</p></li>
<li><p>qos = 1</p></li>
...
<td><div class="line-block">
<div class="line">Device status. This topic is read only.</div>
<div class="line">Refer to <a class="reference internal" href="/docs/en/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-status"><span class="std std-ref">leaps_api.status</span></a></div>
</div>
<ul class="simple">
<li><p>retained = false</p></li>
...
<td><blockquote>
<div><p>Refer to <a class="reference internal" href="/docs/en/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-user-data"><span class="std std-ref">leaps_api.user_data</span></a></p>
<ul class="simple">
<li><p>retained = false</p></li>
<li><p>qos = 1</p></li>
</ul>
...
<td><p>Refer to <a class="reference internal" href="/docs/en/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-service-data"><span class="std std-ref">leaps_api.service_data</span></a></p>
<ul class="simple">
<li><p>retained = false</p></li>
<li><p>qos = 1</p></li>
</ul>
...
<td><p>Refer to <a class="reference internal" href="/docs/en/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-location"><span class="std std-ref">leaps_api.location</span></a></p>
<ul class="simple">
<li><p>retained = false</p></li>
<li><p>qos = 0</p></li>
</ul>
...
<td><p>Refer to <a class="reference internal" href="/docs/en/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-tdoa-external-le"><span class="std std-ref">leaps_api.tdoa_external_le</span></a></p>
<ul class="simple">
<li><p>retained = false</p></li>
<li><p>qos = 0</p></li>
</ul>
...
<td><div class="line-block">
<div class="line">Refer to <a class="reference internal" href="/docs/en/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-service-data"><span class="std std-ref">leaps_api.service_data</span></a></div>
</div>
<div class="line-block">
<div class="line">Example:</div>
...
<td><div class="line-block">
<div class="line">Refer to <a class="reference internal" href="/docs/en/leaps-rtls/integration-guide/leaps-api/mqtt-message-reference#leaps-api-user-data"><span class="std std-ref">leaps_api.user_data</span></a></div>
</div>
<div class="line-block">
<div class="line">Example:</div>
